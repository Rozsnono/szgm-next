...
export default function Home() {
    ...
    async function getData() {
        const res = await fetch("https://szgm-next-server.onrender.com/api/logs");
    ...
    async function banUser(user: any) {
        ...
        await fetch("https://szgm-next-server.onrender.com/api/user/" + user._id + "/" + !user.isDeleted, { method: "DELETE" });
    }
    ...
    const commandHandler = (text: string) => {
        ...
        switch (command.toLocaleLowerCase()) {
            ...
            case "ban":
                ...
                fetch("https://szgm-next-server.onrender.com/api/user/" + banUser._id + "/" + true, { method: "DELETE" })
                break;
            ...
            case "unban":
                ...
                fetch("https://szgm-next-server.onrender.com/api/user/" + banUser2._id + "/" + false, { method: "DELETE" })
                break;
