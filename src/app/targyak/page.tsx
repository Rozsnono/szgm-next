...
export default function Home() {
    ...
    async function getData() {
        ...
        const res = await fetch("https://sze-szerver.cyclic.app//api/subjects?url=" + url);
    ...
    async function getSub() {
        const res = await fetch("https://sze-szerver.cyclic.app//api/subjectData");
        const data: any = await res.json();
    ...
    function saving() {
        ...
        fetch("https://sze-szerver.cyclic.app//api/user/" + body._id, {
            method: "PUT",
            headers: {
