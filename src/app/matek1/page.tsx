        ...
        <main className={"flex flex-col h-screen lg:pt-14 pt-12 text-lg bg-gray-100" + (isMobile ? "" : "overflow-hidden")}>
            {
                isMobile.current ?
                            ...
                            numbers.map((number) => {
                                return (
                                    <div key={number} className="flex flex-col items-center justify-center h-screen">
                                        <Image src={`/matek1/matek1_${number}.jpg`} alt="matek1" className="w-screen" width={1200} height={100}></Image>
                                    </div>
                                )
                            })
                    ...
                    :
                    <iframe src="/matek1.pdf" className="h-screen" width="auto" height="auto"></iframe>
            }
        </main>
    );
}