        ...
        <main className={"flex flex-col h-screen lg:pt-14 pt-12 text-lg bg-gray-100 relative" + (isMobile ? "" : "overflow-hidden")}>
...

            {
                isMobile.current ?
                            ...
                            numbers.map((number) => {
                                return (
                                    <div key={number} className="flex flex-col items-center justify-center h-screen">
                                        <Image src={`/mikro/mikro9/MEMR-9.-lecke-vázlat-${number}.jpg`} alt="mikro" className="w-screen" width={1200} height={100}></Image>
                                    </div>
                                )
                            })
                    ...
                    :
                    <iframe src={"/memr9.pdf"} className="h-screen" width="auto" height="auto"></iframe>
            }
        </main>
    );
}